...
IF EXISTS(SELECT * FROM sys.objects WHERE type = 'P' AND name = 'CarhallaDbReset')
...
BEGIN
	...
	(3, CONVERT(DATE, '1/1/2019'), 'false', 'true', 'false', 3, 1200, '3ABC3ABC3ABC3ABC3', 5, 3, 1, 3, 2, 5, 22669, 24500, '/Images/2017FordEscape.png', 'Loaded! Used Price for Brand New Quality.' ),
